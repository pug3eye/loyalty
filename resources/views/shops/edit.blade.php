          ...
          <form class="form-horizontal" method="post" action="{{ URL::current() }}" id="form_edit" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-sm-12 col-md-10 col-lg-8">
                  ...
                  <div class="col-sm-6 col-sm-offset-1 col-md-7 col-md-offset-1 col-lg-6 col-lg-offset-1">
                    <textarea class="form-control" name="detail" rows="4" cols="50">{{ $user->detail }}</textarea>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-sm-12 col-md-10 col-lg-8">
                  ...
                  <div class="col-sm-5 col-sm-offset-1 col-md-5 col-md-offset-1 col-lg-5 col-lg-offset-1">
                    <input type="text" class="form-control" name="discount" value="{{ $user->discount}}">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-sm-12 col-md-10 col-lg-8">
                  ...
                  <div class="col-sm-5 col-sm-offset-1 col-md-5 col-md-offset-1 col-lg-5 col-lg-offset-1">
                    <input type="text" class="form-control" name="start_point" value="{{ $user->start_point}}">
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="col-sm-8 col-sm-offset-1 col-md-8 col-md-offset-1 col-lg-8 col-lg-offset-1">
                    <div class="form-inline">
                      <div class="input-group">
                        <input type="text" class="form-control input-sm" size="7" name="point_get" value="{{ $user->point_get }}">
                        <div class="input-group-addon no-border">Points,</div>
                        <div class="input-group-addon no-border">Every</div>
                        <input type="text" class="form-control input-sm" size="7" name="point_condition" value="{{ $user->point_condition }}">
            ...
            <div class="row">
              <div class="form-group{{$errors->has('image') ? ' has-error' : ''}}">
                <div class="col-sm-12 col-md-10 col-lg-8">
                  <label class="control-label col-sm-4 col-md-4 col-lg-3">Shop Logo</label>
    ...
    <script>
      function deleteRewardImage() {
        swal({
          ...
          $.post("{{ url('edit/logo') }}", function(result) {
